...
-- ===========================================
-- PART 2: Multi-Agent Architecture Migration
-- ===========================================
...
SELECT
    ...
    (SELECT COUNT(*) FROM information_schema.columns WHERE table_name='accounts' AND column_name='max_agents') as accounts_updated,
    (SELECT COUNT(*) FROM information_schema.routines WHERE routine_name='exec_sql') as exec_sql_exists;
